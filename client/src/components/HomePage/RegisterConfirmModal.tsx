...
const RegisterConfirmModal: React.FC<RegisterConfirmModal> = (props) => {
    ...
    const register = async (values: any) => {
        const data = await request('/api/auth/register', 'POST', values, 'json')
        console.log(data)
                    ...
                    <div className='homePageModalWrapper'>
                        ...
                        <div className='homePageModalContent'>
                            <Form className='formRegister'>
                                ...
                                <div className='formInputs'>                                  
                                    <Field onChange={() => props.setModal('register')} className={errorMessage != '' ? "formInput formInputError" : "formInput"} name='email' value={values.email} placeholder='Адрес электронной почты'/>
